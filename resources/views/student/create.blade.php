                ...
                <div class="card-body">
                    <form method="POST" action=" {{ url('student/save') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="roll" type="text" class="form-control {{ $errors->has('roll') ? ' is-invalid':''}}" name="roll" value="{{ old('roll') }}" required autocomplete="roll" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="reg_id" type="text" class="form-control {{ $errors->has('reg_id') ? ' is-invalid':''}}" name="reg_id" value="{{ old('reg_id') }}" required autocomplete="reg_id" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="father_name" type="text" class="form-control {{ $errors->has('father_name') ? ' is-invalid':''}}" name="father_name" value="{{ old('father_name') }}" required autocomplete="father_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mother_name" type="text" class="form-control {{ $errors->has('mother_name') ? ' is-invalid':''}}" name="mother_name" value="{{ old('mother_name') }}" required autocomplete="mother_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cgpa" type="text" class="form-control {{ $errors->has('cgpa') ? ' is-invalid':''}}" name="cgpa" value="{{ old('cgpa') }}" required autocomplete="cgpa" autofocus>
